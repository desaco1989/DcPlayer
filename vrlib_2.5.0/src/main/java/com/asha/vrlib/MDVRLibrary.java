...
public class MDVRLibrary {
    ...
    private void initTouchHelper(Builder builder) {
        ...
        mTouchHelper.setICallback(new ITouchCallback() {
            @Override
            public void sendMsg(String msgType, String msgContent) {//TODO
                if(mIEventCallback != null){
                    mIEventCallback.sendEventMsg(msgType,msgContent);
                }
            }
        });
    }

    private IEventCallback mIEventCallback;//TODO 定义接口，通过接口传递信息

    public interface IEventCallback {
        public void sendEventMsg(String type, String content);
    }

    public void setEventCallback(IEventCallback iEventCallback) {
        mIEventCallback = iEventCallback;
    }
