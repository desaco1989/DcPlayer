...
public class VideoPlayerActivity extends MD360PlayerActivity {
    ...
    protected MDVRLibrary createVRLibrary() {
        return MDVRLibrary.with(this)
                ...
                .pinchConfig(new MDPinchConfig().setMin(1.0f).setMax(8.0f).setDefaultValue(0.1f)) // setMin(1.0f).setMax(8.0f).setDefaultValue(0.1f)
                .pinchEnabled(true)
                .directorFactory(new MD360DirectorFactory() {
                    @Override
                    public MD360Director createDirector(int index) {
                        return MD360Director.builder().setPitch(90).build();//90
                    }
                })
